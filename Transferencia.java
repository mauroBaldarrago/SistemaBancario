public class Transferencia extends Transaccion{
    ...
    public Transferencia(String idTransaccion, double monto, String fecha, Cliente cliente1, Cliente cliente2, Empleado empleado){
        super(idTransaccion, monto, fecha, cliente1, empleado);
